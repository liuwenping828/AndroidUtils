...
public class IntentUtils {
    ...
    public static void startShareActivity(@NonNull Context context, @NonNull String subject,
                                          @NonNull String text, @Nullable String chooserTitle) {
        try {
    ...
    public static void startCalendarActivity(@NonNull Context context, @NonNull String title,
                                             @Nullable String description, long beginTime, long endTime) {
        try {
    ...
    public static boolean isCallable(@NonNull Context context, @NonNull Intent intent) {
        List<ResolveInfo> list = context.getApplicationContext().getPackageManager()
